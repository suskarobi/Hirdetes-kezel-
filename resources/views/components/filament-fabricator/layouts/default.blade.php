...
<header class="fixed top-0 left-0 right-0 bg-black/90 backdrop-blur-md border-b border-white/20 z-50">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav class="hidden md:flex gap-6 text-sm uppercase font-semibold text-white">
            ...
            <a href="#" class="hover:text-gray-300 transition-colors duration-300">Vásárlás</a>
            <a href="#" class="hover:text-gray-300 transition-colors duration-300">Bérlés</a>
            ...
            <a href="#" class="hover:text-gray-300 transition-colors duration-300">Politika</a>
        </nav>
